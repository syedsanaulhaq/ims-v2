-- ============================================================================
-- Add Financial Year Support to Opening Balance System
-- Run this script to enable year-wise inventory tracking
-- ============================================================================

USE IMS;
GO

PRINT '=== Adding Financial Year Support ===';
PRINT '';
...
BEGIN
    CREATE TABLE financial_years (
        ...
        INDEX IX_FinancialYear_Code (year_code),
        INDEX IX_FinancialYear_Current (is_current)
    );
...
-- ============================================================================
-- STEP 5: Create view for year-wise inventory summary
-- ============================================================================
PRINT '';
...
PRINT '  ✓ Created vw_yearwise_inventory view';
...
PRINT '';
PRINT 'Next Steps:';
PRINT '1. Update backend APIs to support financial_year parameter';
PRINT '2. Update Opening Balance Entry UI with year selector';
PRINT '3. Create Year-Wise Inventory Report page';
GO
